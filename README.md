...
The system supports two recommendation protocols (**LOOCV** and **Majority Voting**) and two task formulations (**Task-A** and **Task-B**).

---

## Framework

![Framework Overview](./images/Workflow.png)
